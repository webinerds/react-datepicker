...
import { formatYear, getYear } from "./date_utils";
  ...
  renderOptions = () => {
    ...
    var options = this.state.yearsList.map(year => (
      ...
      >
        ...
        {formatYear(year, this.props.calendar)}
      </div>
    ));

    const minYear = this.props.minDate
      ? getYear(this.props.minDate, this.props.calendar)
      : null;
    const maxYear = this.props.maxDate
      ? getYear(this.props.maxDate, this.props.calendar)
      : null;
